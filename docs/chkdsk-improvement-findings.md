...
- [`scripts/claim-scenario.sh`](../scripts/claim-scenario.sh) — atomic
  claim of a pending scenario by an agent.
- [`scripts/update-scenario-status.sh`](../scripts/update-scenario-status.sh)
  — set the status of a scenario after the runner finishes.
- [`scripts/reset-non-passed.sh`](../scripts/reset-non-passed.sh) —
