...
- [`harness/scripts/claim-scenario.sh`](../harness/scripts/claim-scenario.sh) — atomic
  claim of a pending scenario by an agent (vendored from `fs-test-harness`).
- [`harness/scripts/update-scenario-status.sh`](../harness/scripts/update-scenario-status.sh)
  — set the status of a scenario after the runner finishes.
- [`harness/scripts/reset-non-passed.sh`](../harness/scripts/reset-non-passed.sh) —
