...
rename), ADS, reparse points, EAs. That's the "80% of NTFS driver
...
(we already do READONLY via file attribute tools); punt on full ACL support.
...
Today: Ubuntu-latest only. Add macOS-latest (important — NTFS driver
